    ...
    useEffect(() => {
      const fetchProduct = async () => {
          try {
              ...
              const productExists = cartData.Products.some(p => String(p.id) === String(id));
        ...
        <div className="max-w-6xl w-full px-6">
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="mt-6">
                        <p className="text-gray-500/70 line-through">Price: ${product.oldprice ? Number(product.old_price).toFixed(2) : (product.price * 1.2).toFixed(2)}</p>
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        <button onClick={handleClick} className={`w-full py-3.5 cursor-pointer font-medium
                         bg-gray-100 text-gray-800/80 hover:bg-gray-200 transition 
                            ${inCart ? "font-semibold text-teal-400" : "text-gray-800/80"}
                            `} 
                        >
