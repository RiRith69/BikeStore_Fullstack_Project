...
async function seedDatabase() {
  try {
    ...
    // Step 2: Insert User
    const usersData = [
        { first_name: "Sophearith", last_name: "Chren", phone_number: 855123456789, email: "sophearith.chren@bikestore.org", password: "CSPR@123", role: "admin" },
        { first_name: "Lyheng", last_name: "Touch", phone_number: 855987654321, email: "lyheng.touch@bikestore.org", password: "TLH@0123", role: "staff" },
        { first_name: "Phearinsathya", last_name: "Rith", phone_number: 85596366993, email: "phearinsathya.rith@bikestore.org", password: "RPRS@123", role: "manager" },
      ];
